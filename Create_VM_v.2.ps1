...
New-VM -Name $VMName -BootDevice VHD -NewVHDPath "C:\VM\$VMName\Virtual Hard Disks\$VMName.vhdx" -Path C:\VM\ -NewVHDSizeBytes 40GB -Generation 2 -Switch "vSwitch - External"
